-- ================================================================
-- GIGGA – ENHANCE APPLICATION PROCESS WITH NOTIFICATIONS
-- TEMPORARILY DISABLED: Payment tracking features
-- Run this in Supabase SQL Editor to add notification features
-- ================================================================

-- TEMPORARILY DISABLED: Payment tracking to applications table
...
-- 2. Add notification tracking
ALTER TABLE public.notifications ADD COLUMN IF NOT EXISTS read_at TIMESTAMPTZ;

-- TEMPORARILY DISABLED: Payment history table
...
-- TEMPORARILY DISABLED: Payment history RLS and policies
...
-- TEMPORARILY DISABLED: Payment history indexes
...
-- 3. Add function to automatically create notifications for application status changes
...
BEGIN
  ...
  IF OLD.status IS DISTINCT FROM NEW.status THEN
    ...
    VALUES (
      ...
      END,
      CASE NEW.status
        WHEN 'accepted' THEN 'Your application has been accepted! Contact the business to arrange next steps.'
...
-- 4. Create trigger for automatic notifications
...
-- 5. Create function to update job status when filled
...
-- 6. Create trigger for job status updates
